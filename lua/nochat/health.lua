...
M.check = function()
    ...
    if pcall(require, "telescope") then
        ...
        if telescope.extensions and telescope.extensions["http_client"] then
            health.ok("Telescope nochat extension is properly loaded")
        else
            health.warn("Telescope nochat extension is not loaded",
                "Make sure to load the extension with require('telescope').load_extension('nochat')")
        end
    else
